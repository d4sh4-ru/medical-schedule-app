...
export default function StockScreen() {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      const updatedStock = {
        id: selectedStock.id,
        medicationTradeName: selectedStock.medicationTradeName,
        requestDate: selectedStock.requestDate,
        restockDate: selectedStock.restockDate,
      ...
      const updatedStocks = stocks.map((stock) => (stock.id === selectedStock.id ? newStock : stock));
